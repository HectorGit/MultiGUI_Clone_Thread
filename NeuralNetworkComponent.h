...
{
public:
	NeuralNetworkComponent() : Thread("OpenNN Thread")
	{
		...
		setSize(200, 200);
		startThread(); //this is problematic, will train the NN immediately. 
	}
	...
	void run() override 
	{
		actuallyTrainNeuralNetwork();//call dummy function that calls actual function.
		//stopThread();//needs parameter?
		//i have no idea how many milliseconds
		//this takes.
